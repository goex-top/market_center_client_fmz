...
var chartBTC_USDT = {
    ...
    series : [                                          // 数据系列，该属性保存的是 各个 数据系列（线， K线图， 标签等..）
        {name : "bitmex",      id : "bitmex, BTC_USDT",      data : [], yAxis: 0,type:'area', showInLegend: true, tooltip:{valueDecimals: 2, valueSuffix: ' USDT'}}, // 索引为1，设置了dashStyle : 'shortdash' 即：设置 虚线。
        {name : "binance",      id : "binance, BTC_USDT",      data : [], yAxis: 0, showInLegend: true, tooltip:{valueDecimals: 2, valueSuffix: ' USDT'}}, // 索引为1，设置了dashStyle : 'shortdash' 即：设置 虚线。
        ...
        {name : "bitmex diff",      id : "bitmex diff, BTC_USDT",      data : [], yAxis: 1,showInLegend: true, tooltip:{valueDecimals: 2, valueSuffix: ' USDT'}}, // 索引为1，设置了dashStyle : 'shortdash' 即：设置 虚线。
...
function init() {
    ...
    config.push({exchange:'bitmex.com', contractType:"", pair:'BTC_USDT'})
